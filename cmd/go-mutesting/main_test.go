...
func TestMain(t *testing.T) {
	testMain(
		...
		returnOk,
		"The mutation score is 0.500000 (7 passed, 7 failed, 9 duplicated, 0 skipped, total is 14)",
	)
}
...
func TestMainRecursive(t *testing.T) {
	testMain(
		...
		[]string{"--debug", "--exec-timeout", "1", "./..."},
		returnOk,
		"The mutation score is 0.533333 (8 passed, 7 failed, 9 duplicated, 0 skipped, total is 15)",
	)
}
